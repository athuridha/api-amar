                ...
                {activeTab === 'customers' && (
                    <div className="bg-white rounded-2xl border border-gray-200/60 shadow-sm overflow-hidden animate-fade-in">
                        ...
                        <div className="p-8 text-center text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900">Customer Data</h3>
                            <p className="mt-1">This detailed view is under development. It will show a list of unique device IDs and their aggregate usage.</p>
                        </div>
                    </div>
                )}
